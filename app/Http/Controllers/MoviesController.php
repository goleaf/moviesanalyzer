...
class MoviesController extends Controller
{
    ...
    public function applyManualMatch(
        ...
        $movieFile->update([
            ...
            'tmdb_original_language' => $movie['tmdb_original_language'] ?? null,
            'tmdb_year' => $movie['release_year'],
            'movie_year' => $movie['release_year'],
            'tmdb_runtime' => $movie['tmdb_runtime'] ?? null,
            'tmdb_release_date' => $movie['tmdb_release_date'] ?? null,
            'tmdb_tagline' => $movie['tmdb_tagline'] ?? null,
            'tmdb_status' => $movie['tmdb_status'] ?? null,
            'tmdb_imdb_id' => $movie['tmdb_imdb_id'] ?? null,
            'tmdb_poster_path' => $movie['poster_path'],
            'tmdb_overview' => $movie['overview'],
            'tmdb_vote_average' => $movie['vote_average'],
            'tmdb_popularity' => $movie['tmdb_popularity'] ?? null,
            'tmdb_vote_count' => $movie['tmdb_vote_count'] ?? null,
            'tmdb_url' => $movie['tmdb_url'],
            'tmdb_metadata' => isset($movie['tmdb_metadata']) && is_array($movie['tmdb_metadata'])
                ? $movie['tmdb_metadata']
                : null,
