...
return [
    ...
    */
    ...
    'llms_txt' => [
        ...
        'title' => env('LLM_READY_LLMS_TXT_TITLE', config('app.name')),

        // Blockquote summary - brief description of your site/project
        'summary' => env('LLM_READY_LLMS_TXT_SUMMARY', 'Movie library deduplication and TMDB-assisted metadata matching.'),

        // Detailed description paragraphs (array of strings)
        'description' => [
            'MoviesAnalyzer scans SMB libraries, parses filenames, detects duplicates, and helps match unmatched files against TMDB.',
            'Every public HTML page can be requested as markdown by appending .md or by adding ?format=md.',
        ],
        ...
        'sections' => [
            'Core Pages' => [
                ['url' => '/', 'description' => 'Dashboard'],
                ['url' => '/movies', 'description' => 'All Movies'],
                ['url' => '/duplicates', 'description' => 'Duplicates Review'],
                ['url' => '/unmatched', 'description' => 'Unmatched Movies'],
                ['url' => '/parser-rules', 'description' => 'Parser Rules'],
            ],
        ],
